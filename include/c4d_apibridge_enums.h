...
#define GEMB_R_UNDEFINED (GEMB_R::V_UNDEFINED)
#define GEMB_R_OK (GEMB_R::V_OK)
#define GEMB_R_CANCEL (GEMB_R::V_CANCEL)
#define GEMB_R_ABORT (GEMB_R::V_ABORT)
#define GEMB_R_RETRY (GEMB_R::V_RETRY)
#define GEMB_R_IGNORE (GEMB_R::V_IGNORE)
#define GEMB_R_YES (GEMB_R::V_YES)
#define GEMB_R_NO (GEMB_R::V_NO)
...
#define UNDOTYPE_DELETE (UNDOTYPE::DELETEOBJ)
